...
The validated release is
[`v0.1.0-rc.2`](https://github.com/openYuanrong-mirror/ascend-oci-adapter/releases/tag/v0.1.0-rc.2),
which implements protocol schema 1. sandboxd validates the schema returned by
the configured executable; packaging and checksum pinning remain deployment
responsibilities.
